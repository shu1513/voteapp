...
- Row fields: `COMMITTEEID` (internal id), `CANDIDATE`, `CANDIDATESTATUS`, `BEGINNINGFUNDS`, `MONETARYCONTRIB`, `MONETARYEXP`, `NONMONETARYCONTRIB`, `OTHERSOURCES`, `ENDINGFUNDS`, `YEAR`.
