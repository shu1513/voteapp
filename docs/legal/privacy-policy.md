...
**Content reports.** If you report inaccurate or outdated content, we store the report message, the content item you identified, any optional source URL, and any optional contact email you provide so we can investigate and improve accuracy. Do not include sensitive personal information in content reports.
