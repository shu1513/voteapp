...
- fail closed on a selected row with an unknown transaction type or stance, a non-ISO date, or a bad amount; on a linked registration missing from the grid or without an office. Rows of other races are never validated.
