...
describe("BallotPage", () => {
  ...
  it("renders election cards under a date heading, with only public sorts", async () => {
    ...
    // The date heading is the page's visible identity — the "Upcoming elections"
    ...
    expect(screen.getByRole("heading", { level: 1, name: "Upcoming elections" })).toHaveClass("sr-only");
