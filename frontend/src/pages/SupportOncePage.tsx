  ...
  return (
    <div className="mx-auto max-w-3xl space-y-6 px-4 py-8">
      ...
      {me?.email_verified ? (
        ...
        <p className="text-sm">
          <Link to="/login?next=%2Fsupport%2Fonce" className="font-semibold underline hover:text-ink">
            Log in
          </Link>{" "}
          or{" "}
          <Link to="/register?next=%2Fsupport%2Fonce" className="font-semibold underline hover:text-ink">
            sign up
          </Link>{" "}
