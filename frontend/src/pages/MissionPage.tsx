  ...
  return (
    <div className="mx-auto max-w-3xl space-y-6 px-4 py-8">
      <section className="space-y-3 text-sm text-ink">
        ...
        <h2 className="pt-2 text-lg font-semibold">Why do we do what we do?</h2>
        ...
        <h2 className="pt-2 text-lg font-semibold">Do our votes matter?</h2>
        <p>
        ...
        <h2 className="pt-2 text-lg font-semibold">Who are these candidates?</h2>
        <p>
        ...
        <h2 className="pt-2 text-lg font-semibold">What {APP_NAME} does</h2>
        <p>
        ...
        <h2 className="pt-2 text-lg font-semibold">How we do it</h2>
        <p>
