    ...
    <div className="mx-auto max-w-3xl px-4 py-8">
      ...
      {measure ? (
        <section className="mt-6 rounded-lg border border-gray-200 bg-white p-4">
          ...
          {measure.summary ? <p className="mt-2 text-sm text-gray-700">{measure.summary}</p> : null}
          ...
          <div className="mt-3 space-y-3">
            {data.candidates.map((candidate) => (
              ...
              >
                ...
                {candidate.summary ? (
                  <p className="mt-2 line-clamp-3 text-sm text-gray-700">{candidate.summary}</p>
                ) : null}
              </Link>
            ))}
          </div>
      ...
      {data.sources.length > 0 ? (
        <section className="mt-6">
          <h2 className="text-sm font-semibold text-gray-700">Election sources</h2>
