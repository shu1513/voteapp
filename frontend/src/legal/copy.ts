...
export const PRE_SEARCH_CHECKBOX_LABEL =
  ...
  "with official election authorities before relying on it.";
...
export const AI_BANNER =
  "AI-assisted research — verify before relying on it. This information may be inaccurate, incomplete, or " +
  "outdated, and is not official election information.";
