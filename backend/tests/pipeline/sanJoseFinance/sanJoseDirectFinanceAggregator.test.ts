...
import { aggregateSanJoseDirectFinance } from "../../../src/pipeline/sanJoseFinance/sanJoseDirectFinanceAggregator.js";

// Every scenario below reproduces a phenomenon observed in the live 2025+2026
// San José exports (plan Phase 0/3 audits, dry-run 2026-08-10).
...
function aggregate(input: {
  ...
  return aggregateSanJoseDirectFinance({
    filerId: FILER,
...
describe("aggregateSanJoseDirectFinance", () => {
