...
const MIGRATION_SQL = readFileSync(
  new URL("../../../../db/migrations/117_add_texas_campaign_finance_tables.sql", import.meta.url),
  "utf8"
);
...
describe("texasBallotLookupFinanceLoader", () => {
  ...
  // selected outside_group.expenditure_count, a column migration 117 never
  ...
  it("only references outside-group columns that migration 117 creates", async () => {
