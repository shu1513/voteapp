...
export function buildCandidateProfilePrompt(input: CandidateProfilePromptInput): string {
  ...
  return [
    ...
    '  "has_held_public_office": true|false|null,',
    '  "summary": "2-sentence neutral voter summary (optional)",',
    '  "sources": ["https://..."]',
    "}",
    "",
    "Rules:",
    ...
    "- has_held_public_office is required: true if this person has EVER held elected or appointed public office (current or former, including judicial office), false if a source covering their office history shows none, null if no source you cite carries office history — a page with no office-history field is not evidence of never having held office.",
