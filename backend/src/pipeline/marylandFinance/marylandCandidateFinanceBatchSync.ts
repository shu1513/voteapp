...
export type MarylandCandidateFinanceDueRow = StandardStateFinanceDueRow;
...
export const listDueMarylandCandidateFinanceSyncRows = createStandardStateFinanceDueListQuery({
  state: "MD",
  tables: {
