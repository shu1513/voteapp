...
export type MarylandFinanceAutoLinkCandidateElection = {
  candidateId: string;
  electionId: string;
...
function mapCandidateElectionRow(row: CandidateElectionQueryRow): MarylandFinanceAutoLinkCandidateElection {
  return {
...
export async function listMarylandCandidateElectionsMissingFinanceLinks(
  db: Queryable,
  input: {
    now: Date;
...
): Promise<MarylandFinanceAutoLinkCandidateElection[]> {
