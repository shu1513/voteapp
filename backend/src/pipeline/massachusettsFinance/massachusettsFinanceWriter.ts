  ...
  await input.db.query(
    `
      ...
      DO UPDATE SET
        ...
        direct_contribution_total = COALESCE(EXCLUDED.direct_contribution_total, ma_candidate_finance_summaries.direct_contribution_total),
        total_disbursements = COALESCE(EXCLUDED.total_disbursements, ma_candidate_finance_summaries.total_disbursements),
        cash_on_hand = COALESCE(EXCLUDED.cash_on_hand, ma_candidate_finance_summaries.cash_on_hand),
        outside_support_total = EXCLUDED.outside_support_total,
        outside_oppose_total = EXCLUDED.outside_oppose_total,
        source_url = COALESCE(EXCLUDED.source_url, ma_candidate_finance_summaries.source_url),
