...
type OregonFinanceDirectBreakdownRow = StateFinanceDirectBreakdownRow;
type OregonFinanceOutsideIndustryRow = StateFinanceOutsideIndustryRow;
type OregonFinanceSummaryRow = StateFinanceSummaryRow;
type OregonFinanceOutsideGroupRow = StateFinanceOutsideGroupRow;
type OregonFinanceOutsideDonorEvidenceRow = StateFinanceOutsideDonorEvidenceRow;
const GENERIC_OREGON_ORESTAR_SOURCE_URL = "https://secure.sos.state.or.us/orestar/gotoPublicTransactionSearch.do";

export async function loadOregonCandidateFinanceSummariesByCandidateElection(
  db: Queryable,
