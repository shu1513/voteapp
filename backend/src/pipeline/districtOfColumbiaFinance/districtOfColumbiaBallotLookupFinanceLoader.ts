...
type DistrictOfColumbiaFinanceDirectBreakdownRow = StateFinanceDirectBreakdownRow;
type DistrictOfColumbiaFinanceOutsideIndustryRow = StateFinanceOutsideIndustryRow;
type DistrictOfColumbiaFinanceSummaryRow = StateFinanceSummaryRow;
type DistrictOfColumbiaFinanceOutsideGroupRow = StateFinanceOutsideGroupRow;
type DistrictOfColumbiaFinanceOutsideDonorEvidenceRow = StateFinanceOutsideDonorEvidenceRow;
