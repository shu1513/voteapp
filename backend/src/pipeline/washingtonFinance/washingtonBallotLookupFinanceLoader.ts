...
type WashingtonFinanceDirectBreakdownRow = StateFinanceDirectBreakdownRow;
type WashingtonFinanceOutsideIndustryRow = StateFinanceOutsideIndustryRow;
type WashingtonFinanceSummaryRow = StateFinanceSummaryRow;
type WashingtonFinanceOutsideGroupRow = StateFinanceOutsideGroupRow;
type WashingtonFinanceOutsideDonorEvidenceRow = StateFinanceOutsideDonorEvidenceRow;
