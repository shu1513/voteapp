...
type HawaiiFinanceDirectBreakdownRow = StateFinanceDirectBreakdownRow;
type HawaiiFinanceOutsideIndustryRow = StateFinanceOutsideIndustryRow;
type HawaiiFinanceSummaryRow = StateFinanceSummaryRow;
type HawaiiFinanceOutsideGroupRow = StateFinanceOutsideGroupRow;
type HawaiiFinanceOutsideDonorEvidenceRow = StateFinanceOutsideDonorEvidenceRow;
