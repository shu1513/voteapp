...
const EXACT_OCCUPATION_RULES = new Map<string, ClassificationRule>([
  ["ATTORNEY", { industrySlug: "legal", confidence: "high", name: "occupation_exact_attorney" }],
  ["LAWYER", { industrySlug: "legal", confidence: "high", name: "occupation_exact_lawyer" }],
  ...
  ["FARMER", { industrySlug: "agriculture", confidence: "high", name: "occupation_exact_farmer" }],
...
const OCCUPATION_PATTERN_RULES: readonly PatternRule[] = [
  { pattern: /\b(ATTORNEY|LAWYER|LAW FIRM|LEGAL)\b/, industrySlug: "legal", confidence: "medium", name: "occupation_pattern_legal" },
  ...
  { pattern: /\b(FARM|FARMER|RANCH|AGRICULTURE)\b/, industrySlug: "agriculture", confidence: "medium", name: "occupation_pattern_agriculture" },
...
const ORGANIZATION_PATTERN_RULES: readonly PatternRule[] = [
  ...
  { pattern: /\b(HOSPITAL|HEALTH|MEDICAL|PHARMA|PHARMACEUTICAL|CLINIC|KAISER)\b/, industrySlug: "healthcare", confidence: "medium", name: "organization_pattern_healthcare" },
  ...
  { pattern: /\b(FARM|RANCH|AGRICULTURE|FOODS?)\b/, industrySlug: "agriculture", confidence: "medium", name: "organization_pattern_agriculture" },
  ...
  { pattern: /\b(TELECOM|COMMUNICATIONS|WIRELESS|BROADBAND)\b/, industrySlug: "telecom", confidence: "medium", name: "organization_pattern_telecom" },
