...
type MarylandFinanceSummaryRow = StateFinanceSummaryRow;
type MarylandFinanceDirectBreakdownRow = StateFinanceDirectBreakdownRow;
type MarylandFinanceOutsideGroupRow = StateFinanceOutsideGroupRow;
type MarylandFinanceOutsideIndustryRow = StateFinanceOutsideIndustryRow;
type MarylandFinanceOutsideDonorEvidenceRow = StateFinanceOutsideDonorEvidenceRow;
type MaineFinanceSummaryRow = StateFinanceSummaryRow;
type MaineFinanceDirectBreakdownRow = StateFinanceDirectBreakdownRow;
type MaineFinanceOutsideGroupRow = StateFinanceOutsideGroupRow;
type MaineFinanceOutsideIndustryRow = StateFinanceOutsideIndustryRow;
type MaineFinanceOutsideDonorEvidenceRow = StateFinanceOutsideDonorEvidenceRow;
type IllinoisFinanceSummaryRow = StateFinanceSummaryRow;
type IllinoisFinanceDirectBreakdownRow = StateFinanceDirectBreakdownRow;
type IllinoisFinanceOutsideGroupRow = StateFinanceOutsideGroupRow;
type IllinoisFinanceOutsideIndustryRow = StateFinanceOutsideIndustryRow;
type IllinoisFinanceOutsideDonorEvidenceRow = StateFinanceOutsideDonorEvidenceRow;
type MinnesotaFinanceSummaryRow = StateFinanceSummaryRow;
type MinnesotaFinanceOutsideGroupRow = StateFinanceOutsideGroupRow;
type MinnesotaFinanceOutsideIndustryRow = StateFinanceOutsideIndustryRow;
...
type TennesseeFinanceOutsideGroupRow = StateFinanceOutsideGroupRow;
type TennesseeFinanceOutsideIndustryRow = StateFinanceOutsideIndustryRow;
type TennesseeFinanceOutsideDonorEvidenceRow = StateFinanceOutsideDonorEvidenceRow;
