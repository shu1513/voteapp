...
export type NewYorkFinanceAutoLinkCandidateElection = {
  candidateId: string;
  electionId: string;
...
function mapCandidateElectionRow(row: CandidateElectionQueryRow): NewYorkFinanceAutoLinkCandidateElection {
  return {
    ...
    district: normalizeNewYorkDistrict(row.district),
  };
}

export async function listNewYorkCandidateElectionsMissingFinanceLinks(
  db: Queryable,
  input: {
    now: Date;
...
): Promise<NewYorkFinanceAutoLinkCandidateElection[]> {
