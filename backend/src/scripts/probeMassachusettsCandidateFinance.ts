...
export function parseProbeMassachusettsCandidateFinanceArgs(
  ...
  return {
    ...
    contributionItemLimit: readStrictPositiveIntegerFlag(args, "--contribution-limit"),
    iepacReportLimit: readStrictPositiveIntegerFlag(args, "--iepac-report-limit") ?? DEFAULT_IEPAC_REPORT_LIMIT,
