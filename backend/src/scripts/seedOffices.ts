...
const SEED_OFFICES: SeedOffice[] = [
  ...
  },
  {
    ...
    summary: [
      "Your secretary of state runs state elections and keeps official state records.",
      "How elections are run and how results are certified",
      "Voter registration and voting rules in your state",
  ...
  },
  {
    ...
    summary: [
      "County judges hear trials, including criminal cases, lawsuits, family, and probate matters.",
      "Outcomes of trials in the county",
      "Rulings on evidence and sentences",
