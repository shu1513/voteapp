...
function parseDataSourceMode(args: readonly string[]): AlaskaApocDataSourceMode {
  ...
  const rawMode = readStrictFlagValue(args, "--data-source");
  if (rawMode !== null) {
    if (liveFlag || csvFlag) {
...
export function parseProbeAlaskaCandidateFinanceArgs(args: readonly string[]): AlaskaFinanceProbeArgs {
  return {
    ...
    incomeCsvPath: readStrictFlagValue(args, "--income-csv"),
    independentExpendituresCsvPath: readStrictFlagValue(args, "--ie-expenditures-csv"),
    independentContributionsCsvPath: readStrictFlagValue(args, "--ie-contributions-csv"),
    incomeUrl: readStrictFlagValue(args, "--income-url"),
    independentExpendituresUrl: readStrictFlagValue(args, "--ie-expenditures-url"),
    independentContributionsUrl: readStrictFlagValue(args, "--ie-contributions-url"),
    ...
    candidateFilerName: readStrictFlagValue(args, "--candidate-filer-name"),
