# New Mexico roll-call evidence — 2023 regular session (LegiScan session 2030)
...
- `legiscan-people-nm-2030.json` — the people snapshot the resolver wrote, so the importer can run
...
**20 measures, 898 records, on the local database only. Production holds no New Mexico
roll-call records.**
