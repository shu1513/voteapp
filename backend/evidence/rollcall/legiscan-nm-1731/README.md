# New Mexico roll-call evidence — 2020 regular session (LegiScan session 1731)
...
- `legiscan-people-nm-1731.json` — the people snapshot the resolver wrote, so the importer can run
...
**13 measures, 299 records, on the local database only. Production holds no New Mexico
roll-call records.**
