# New Mexico roll-call evidence — 2022 third special session (LegiScan session 1977)
...
- `legiscan-people-nm-1977.json` — the people snapshot the resolver wrote, so the importer can run
  from committed evidence alone.
- `survey/` — the survey report for the session.
- `PLAN.md` — why this session contributes no records.

## Status

**No measures imported from this session.** See `PLAN.md`.
