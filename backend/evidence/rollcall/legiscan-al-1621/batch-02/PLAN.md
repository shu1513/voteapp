# Alabama 2019 Regular Session batch-02 — selection plan
...
7 rolls on 7 measures, 185 records across 74 candidates. Tallies and labels are in
`judgments.json`.

## Dropped

Dropped: SB 421 (electronic bingo in Macon County), a local act for one county.
