...
- `JUDGING.md` — how each batch-01 measure was judged and why the drops were dropped.
- `divided-enacted-worklist.tsv` — all 121 closely divided votes on measures that became law, each with a disposition.
...
- `batch-01/judgments.json` — the ten judgments as applied.
