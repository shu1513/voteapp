# New Mexico roll-call evidence — 2021 regular session (LegiScan session 1812)
...
- `legiscan-people-nm-1812.json` — the people snapshot the resolver wrote, so the importer can run
...
**15 measures, 455 records, on the local database only. Production holds no New Mexico
roll-call records.**
