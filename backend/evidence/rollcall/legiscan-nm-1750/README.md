# New Mexico roll-call evidence — 2020 first special session (LegiScan session 1750)
...
- `legiscan-people-nm-1750.json` — the people snapshot the resolver wrote, so the importer can run
...
**3 measures, 72 records, on the local database only. Production holds no New Mexico
roll-call records.**
