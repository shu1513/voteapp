# New Mexico roll-call evidence — 2021 first special session (LegiScan session 1830)
...
- `legiscan-people-nm-1830.json` — the people snapshot the resolver wrote, so the importer can run
...
**1 measures, 31 records, on the local database only. Production holds no New Mexico
roll-call records.**
