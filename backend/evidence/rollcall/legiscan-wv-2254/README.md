...
- 1,027 floor votes kept
- 377 roll calls excluded by rule as procedural: the separate effective-date votes, amendments, and motions
- 6 roll calls surfaced and never queued: 0 with an unknown question, plus the 6 rolls held by the audit
...
The first four lines add up to the dataset's 1,432 roll calls.
...
Across both sessions 1,409 of 1,423 rolls match on all three. The 6 that
