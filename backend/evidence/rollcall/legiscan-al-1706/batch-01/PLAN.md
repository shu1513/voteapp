# Alabama 2020 Regular Session batch-01 — selection plan
...
2 rolls on 1 measures, 74 records across 74 candidates. The full list, with
tallies and labels, is in `judgments.json`.

## Dropped under filter 5

Dropped: nothing; HB 147 is the session's only divided measure that became law.
