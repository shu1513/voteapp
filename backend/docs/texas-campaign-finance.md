...
- Industry classification uses deterministic finance-label rules plus the manually researched `finance_label_classifications` rows. No sync path — CLI, trigger, or scheduler — calls AI.
