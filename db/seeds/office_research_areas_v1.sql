...
-- The generous per-office blocks above are kept for provenance, but this
-- final pass is the source of truth for every office it lists: it deletes
-- links outside the curated core set and inserts any missing ones, so
-- re-seeding always converges to the curated state. Offices not listed
-- (President/VP, Governor, U.S. Senator/Representative, state legislators)
-- keep their earlier broad sets deliberately. Rationale and the ADDed
-- Sheriff/immigration + District Attorney/womens_reproductive_rights links:
-- see db/migrations/159_curate_office_research_area_core_sets.sql.
-- ============================================================================
