...
CREATE UNIQUE INDEX uq_user_auth_tokens_token_hash ON user_auth_tokens (token_hash);
CREATE INDEX idx_user_auth_tokens_user_id_purpose_expires_at ON user_auth_tokens (user_id, purpose, expires_at);
