...
-- OpenFEC candidate aggregates can report negative receipts after amendments,
-- refunds, or other corrections. Cash on hand is also a signed balance. Keep
-- other finance totals constrained until the source demonstrates otherwise.
